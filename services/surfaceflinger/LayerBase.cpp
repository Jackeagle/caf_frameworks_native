...
#ifdef QCOMHW
void LayerBase::setS3DCompositionFormat(int hints)
{
    mS3DCompositionFormat = qdutils::CBUtils::getS3DCompositionFormat(hints);
}
#endif
...
void LayerBase::drawS3DUIWithOpenGL(const Region& clip) const
{
    ...
    switch (mS3DCompositionFormat) {
        case qdutils::CBUtils::eS3D_SIDE_BY_SIDE:
            for (int i = 0; i < 4; i++) {
            ...
            break;
        case qdutils::CBUtils::eS3D_TOP_BOTTOM:
            for (int i = 0; i < 4; i++) {
